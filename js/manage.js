var m = {
    ...
    login: function() {
        var that = this;
        var html = '<div class="cont">' + '<div class="inp">' + '<label class="span1" for="username">用户名</label>' + '<input class="span3" type="text" id="username" />' + '</div>' + '<div class="inp">' + '<label class="span1" for="password">密&nbsp;&nbsp;&nbsp;码</label>' + '<input class="span3" type="password" id="password" />' + '</div>' + '<div class="butt" style="margin-left:30px">'
    ...
    register: function() {
        var that = this;
        $('.myalert').hide();
        var html = '<div class="cont">' + '<div class="inp">' + '<label class="span2" for="username">用户名</label>' + '<input class="span3" type="text" id="username" />' + '</div>' + '<div class="inp">' + '<label class="span2" for="password">密&nbsp;&nbsp;&nbsp;码</label>' + '<input class="span3" type="password" id="password" />' + '</div>' + '<div class="inp">' + '<label class="span2" for="repassword">重复密码</label>' + '<input class="span3" type="password" id="repassword" />' + '</div>' + '<div class="inp">' + '<label class="span2" for="nickname">昵&nbsp;&nbsp;&nbsp;称</label>' + '<input class="span3" type="text" id="nickname" />' + '</div>' + '<div class="inp">' + '<label class="span2" for="email">邮&nbsp;&nbsp;&nbsp;箱</label>' + '<input class="span3" type="email" id="email" />' + '</div>' + '<div class="inp">' + '<label class="span1" style="margin-right:85px;">头&nbsp;&nbsp;&nbsp;像</label>' + '<input type="radio" name="head" value="1" checked="checked"/><img  src="img/photo" alt="" />' + '<input type="radio" name="head" value="2"/><img  src="img/photo" alt="" />' + '<input type="radio" name="head" value="3"/><img  src="img/photo" alt="" />' + '<label class="span1" style="margin-right:85px;"></label>' + '<input type="radio" name="head" value="1"/><img  src="img/photo" alt="" />' + '<input type="radio" name="head" value="2"/><img  src="img/photo" alt="" />' + '<input type="radio" name="head" value="3"/><img  src="img/photo" alt="" />' + '</div>' + '<div class="butt" style="margin-left:150px; margin-top:30px">' + '<input type="button" class="btn btn-success btn-large" id="register" value="注册"/>' + '<input type="button" class="btn btn-large" id="cancle" value="取消"/>' + '</div>' + '</div>'
            // that.mAlert(html);
        $('.myalert').html(html);
    ...
    upload: function() {
        var that = this;
        var html = '<iframe frameborder="0" width="500" height="350">' + '</iframe>';
        that.mAlert(html);
        ...
        var html2 = '<div class="cont">' + '<form method="post" action="' + that.url + 'uf" enctype="multipart/form-data">' + '<div class="inp">' + '<label class="span1" for="f">名称</label>' + '<input class="span3" style="margin-top:10px;" type="file" name="f"/>' + '</div>' + '<div class="butt">' + '<input type="button" class="btn btn-success btn-large" id="confirm" value="确定"/>' + '<input type="button" class="btn btn-large" id="cancle" value="取消"/>' + '</div>' + '</form>' + '</div>';
